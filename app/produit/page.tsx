...
const photos: Photo[] = [
  ...
  { path: "/real/exterieur-arriere.webp", label: "Vue arrière", alt: "Vue arrière réelle de la NeoDrive SWITCH" },
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <p>
            ...
            vrais véhicules : extérieur, intérieur et livraison.
          </p>
          ...
          <div className={styles.actions}>
            <a href="https://wa.me/33628261446?text=Bonjour%2C%20je%20souhaite%20recevoir%20une%20vid%C3%A9o%20de%20la%20NeoDrive%20SWITCH" target="_blank" rel="noreferrer">Recevoir une vidéo</a>
      ...
      <section id="galerie" className={styles.gallerySection}>
        <div className={styles.heading}>
          ...
          <p>Uniquement des photos du véhicule : extérieur, intérieur et livraison. Touchez une miniature pour changer de photo.</p>
        </div>
      ...
      <section className={styles.proofStrip}>
        <div><strong>Stock réel</strong><span>Des véhicules réellement disponibles.</span></div>
      ...
      <section className={styles.interior}>
        ...
        <div>
          ...
          <p>Une position de conduite dégagée, des commandes accessibles et les équipements utiles pour les déplacements du quotidien.</p>
      ...
      <section className={styles.steel}>
        <div>
          ...
          <p>La NeoDrive SWITCH privilégie une conception simple et une carrosserie acier. Son petit gabarit facilite le stationnement tout en conservant un véritable habitacle deux places.</p>
        </div>
      ...
      <section className={styles.versions}>
        <div className={styles.heading}><span className={styles.eyebrow}>CHOISISSEZ VOTRE VERSION</span><h2>Un prix clair. Des équipements selon vos besoins.</h2></div>
        <div className={styles.versionGrid}>
          <article><span>VERSION ESSENTIELLE</span><h3>3 990 € TTC</h3><p>Pour aller à l’essentiel avec une voiture électrique neuve.</p><ul><li>Véhicule électrique neuf</li><li>Batterie incluse</li><li>Chargeur 220 V inclus</li><li>Deux places</li></ul></article>
          <article className={styles.comfort}><span>VERSION CONFORT</span><h3>4 990 € TTC</h3><p>Davantage d’équipements pour une utilisation quotidienne plus agréable.</p><ul><li>Caméra et aide au stationnement</li><li>Chauffage et ventilation de toit</li><li>Autoradio, Bluetooth et USB</li><li>Alarme antivol et assistance en côte</li></ul></article>
        </div>
      </section>

      <section className={styles.specSection}>
        <div className={styles.heading}><span className={styles.eyebrow}>CARACTÉRISTIQUES</span><h2>L’essentiel, clairement.</h2></div>
        <div className={styles.specs}>{specs.map(([name, value]) => <article key={name}><span>{name}</span><b>{value}</b></article>)}</div>
      ...
      <section className={styles.delivery}>
        ...
        <div>
          ...
          <a href="https://wa.me/33628261446?text=Bonjour%2C%20je%20souhaite%20conna%C3%AEtre%20les%20NeoDrive%20disponibles" target="_blank" rel="noreferrer">Voir les disponibilités</a>
        </div>
      </section>
